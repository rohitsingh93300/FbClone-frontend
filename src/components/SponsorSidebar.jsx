      ...
      <div className='space-y-4'>
        {
            sponsors.map((sponsor)=>{
              return  <a key={sponsor.id} href={sponsor.url} target="_blank" className='flex items-center space-x-4 hover:bg-gray-200 dark:hover:bg-[#262829] p-2 rounded transition'>
                    <img src={sponsor.image} alt={sponsor.title} className='w-28 h-28 object-cover rounded'/>
                    <div>
